...
文字列操作
　置換            replace upper lower uppercase lowercase extract getdate jumpurl untilclip forclip ifclip
　大文字小文字     upper lower
　半角全角        uppercase lowercase
　URL番号抜き出しアドレス extract
　日付取得 getdate

クリップボード監視
　URLジャンプ   jumpurl
　テキスト監視   untilclip forclip ifclip
